...
import com.AchadosPerdidos.API.Application.DTOs.Response.Photo.S3UploadResponse;
...
public class S3Service implements IStorageService {
    ...
    public String uploadFile(byte[] fileContent, String fileName, String contentType, String folder) {
        try {
            ...
            String s3Key = folder != null ? folder + "/" + timestamp + "/" + uniqueId + fileExtension
            ...
            logger.error(
                    "Bucket S3 não encontrado: {}. Verifique se o bucket existe e se o nome está correto na variável AWS_S3_BUCKET",
                    bucketName);
    ...
    public S3UploadResponse uploadPhoto(byte[] fileContent, String fileName, String contentType,
